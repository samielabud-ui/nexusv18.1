      ...
      {questionsHistory.length > 0 && (
        <section className="max-w-[1800px] mx-auto px-4 md:px-8 mb-12 animate-in slide-in-from-top-4 duration-500">
          <h3 className="text-[10px] font-black text-neutral-500 uppercase tracking-[0.4em] mb-4 flex items-center gap-4">
            Continuar Estudando – Questões <div className="h-px flex-grow bg-neutral-800/50"></div>
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {questionsHistory.map((act) => (
              <div 
                ...
                className="bg-neutral-900/40 border border-neutral-800 p-4 rounded-2xl cursor-pointer hover:border-blue-500 transition-all flex items-center gap-4 group"
              >
